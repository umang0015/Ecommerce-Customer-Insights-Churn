...
An e-commerce business selling products across multiple categories and countries needs to understand:
- Sales performance patterns across products, categories, and countries
- Customer behavior and purchasing characteristics
- Factors associated with customer churn / subscription cancellation
- Which customers are at risk of churn for targeted retention
...
8. **Prescriptive Analytics** - Risk-based recommendations
